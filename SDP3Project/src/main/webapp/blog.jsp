            ...
            <div class="row">
              <div class="col-md-6 col-lg-4 py-3">
                <div class="card-blog">
                  ...
                  <div class="body">
                    <div class="post-title"><a href="blog-single.jsp">What is Business Management?</a></div>
                    <div class="post-excerpt">Lorem, ipsum dolor sit amet consectetur adipisicing elit.</div>
                  </div>
                  <div class="footer">
                    <a href="blog-single.jsp">Read More <span class="mai-chevron-forward text-sm"></span></a>
                  </div>
                </div>
              </div>
