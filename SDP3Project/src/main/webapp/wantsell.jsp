...
<main style="text-align:center">
  ...
  <!-- Price Tables -->
  <section >
    <h5 class="title">Existing Projects</h5>
          ...
          <li class="pc is-selected">
			<table style="width:100%">
				  ...
				  <tr>
				    <th>Want To Sell:</th>
				    <td>
				    <form method="post" action="/updatesellrecord">
				    <input type="hidden" name="id" value=<%= i %> />
				    Yes<input name="sell" type="radio" value="yes" placeholder="Yes">
				    No<input type="radio" name="sell" value="no" placeholder="No">
